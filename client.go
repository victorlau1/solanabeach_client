...
// APIClient manages communication with the Solanabeach Backend API API v0.0.1
...
type APIClient struct {
	...
	TokenSwapApi *TokenSwapApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.TokenSwapApi = (*TokenSwapApiService)(&c.common)
